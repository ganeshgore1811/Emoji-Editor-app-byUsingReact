...
function Home() {
  ...
  <div
    ...
    <div className='app-container relative z-10'>
      <h1 className='header'>Playing with Emojis Using <span
       className='header-highlight'>UseState</span></h1>
       <p className='app-description' > This is a simple React app that demonstrates how 
        to use the{" "}
        <code>useState</code> hook to manage the state in a functional component.
        </p>
        ...
        <div className='angle-container'>
          <img src={ImgRotate} alt="rotate" className='rotate-image'
